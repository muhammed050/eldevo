...
export const unsupportedToolSlugs = new Set<string>([
  "http-status-code-checker", "md5-generator", "regex-generator", "qr-code-generator", "image-to-base64", "base64-to-image", "image-resizer", "image-cropper", "image-compressor", "jpg-to-png", "png-to-jpg", "webp-converter", "favicon-generator", "css-formatter",
]);
