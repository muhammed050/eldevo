...
const imageMake = (slug: string, title: string, keyword: string, description: string): ToolMeta => ({
  slug,
  title,
  h1: `${title} — Free Online Image Tool`,
  category: "Image Tools",
  primaryKeyword: keyword,
  secondaryKeywords: [keyword, `${keyword} online`, "browser image editor", "private image tool"],
  searchIntent: description,
  description,
  features: ["Canvas processing in your browser", "No image upload required", "JPG, PNG and WebP output", "Download the processed image"],
  usageSteps: ["Upload an image.", "Choose the required image settings.", "Process the image locally with Canvas.", "Preview and download the result."],
  codeExample: { input: "JPG / PNG / WebP image", output: "Processed image file" },
  faqs: [
    { q: "Are my images uploaded?", a: "No. Image processing happens locally in your browser using Canvas." },
    { q: "Which formats are supported?", a: "JPG, PNG and WebP are supported for output." },
    { q: "Is the image tool free?", a: "Yes. The ElDevo image tools are free to use in the browser." },
  ],
  related: ["/tools/image-resizer/", "/tools/image-compressor/", "/tools/image-cropper/", "/tools/image-converter/", "/tools/image-rotator/"],
});
...
export const coreTools: ToolMeta[] = [
  ...
  imageMake("image-resizer", "Image Resizer", "image resizer", "Resize JPG, PNG and WebP images to exact dimensions in your browser."),
  imageMake("image-compressor", "Image Compressor", "image compressor", "Compress JPG, PNG and WebP images locally with adjustable output quality."),
  imageMake("image-cropper", "Image Cropper", "image cropper", "Crop images to custom dimensions directly in your browser."),
  imageMake("image-converter", "Image Converter", "image converter", "Convert images between JPG, PNG and WebP formats locally."),
  imageMake("image-rotator", "Image Rotator & Flipper", "image rotator", "Rotate and flip images by 90, 180 or 270 degrees in your browser."),
];
